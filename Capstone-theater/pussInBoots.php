...
<head>
    ...
    <title>Puss in boots: The Last Wish</title>
</head>
    ...
    <main>
        <main>
            <div class="container mt-5 mb-3  pt-4 text-center" id="#">
                <h1 class="h1" id="#"">Puss in boots: The Last Wish</h1>
        </div>
        <div class=" container text-center">
                    <div class="row mt-3 pt-3">
                        <div class="col" id="">
                            <img src="images/puss-in-boots-the-last-wish_ry520xvc_480x.progressive.webp"
                        ...
                        <div class="col" id="">
                            ...
                            <p>
                                <strong> Cast: </strong>
                                Antonio Banderas, Salma Hayek, Ray Winstone, Florence Pugh, Olivia Colman, Da'Vine Joy
                                Randolph, Samson Kayo, John Mulaney, Anthony Mendez, Harvey Guillén, Wagner Moura
                            </p>
                            <p>
